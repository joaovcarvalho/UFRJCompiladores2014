...
temp_int_25 = temp_int_24 + j;
 ...
 goto l_for_cond_7; l_for_fim_7:;
  ...
  i = 0;
l_for_cond_9: 
  temp_boolean_15 = i < magnitude;
temp_boolean_18 = !temp_boolean_15;
 if( temp_boolean_18 ) goto l_for_fim_9;
  j = 0;
l_for_cond_8: 
  temp_boolean_16 = j < grandeza;
temp_boolean_17 = !temp_boolean_16;
 if( temp_boolean_17 ) goto l_for_fim_8;
temp_int_28 = i*10;
temp_int_29 = temp_int_28 + j;
  printf( "%d" , produto[temp_int_29] );
  printf( "%s" , " " );
