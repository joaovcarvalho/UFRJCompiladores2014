...
temp_boolean_2 = !temp_boolean_1;
 ...
 goto l_for_cond_1; l_for_fim_1:;
  printf( "%s" , "=======================\n" );
  printf( "%s" , "Test Pipes array => Disponha[ X ] => EmCompletude[ Exclame X; ]: \n" );
  printf( "%s" , "=======================\n" );
temp_int_3 = 0;
sortArray_int = array;
x_int = array[temp_int_3];l_for_cond_2: 
  temp_boolean_3 = temp_int_3 < 10;
...
temp_int_4 = 0;
sortArray_int = array;
x_int = array[temp_int_4];l_for_cond_5: 
...
temp_int_6 = 0;
l_for_cond_3: 
 temp_boolean_6 = temp_int_6 < temp_int_5;
temp_boolean_8 = !temp_boolean_6;
 if( temp_boolean_8 ) goto l_for_fim_3;
temp_int_8= temp_int_6+ 1;
temp_int_9 = sortArray_int[temp_int_8];
temp_int_10 = sortArray_int[temp_int_6];
temp_boolean_7 = temp_int_10>temp_int_9;
  if( !temp_boolean_7 ) goto l_if_fim_1;
temp_int_7 = sortArray_int[temp_int_6];
sortArray_int[temp_int_6] = sortArray_int[temp_int_8];
sortArray_int[temp_int_8] = temp_int_7;
   l_if_fim_1:;
...
x_int = array[temp_int_4]; goto l_for_cond_5; l_for_fim_5:;
  return 0;
}
