...
x_int = array[temp_int_3];l_for_cond_4: 
  temp_boolean_8 = temp_int_3 < 10;
temp_boolean_9 = !temp_boolean_8;
 if( temp_boolean_9 ) goto l_for_fim_4;
temp_int_4 = 10 - 1;
l_for_cond_3: 
 temp_boolean_3 = temp_int_4 >= 1;
temp_boolean_7 = !temp_boolean_3;
 if( temp_boolean_7 ) goto l_for_fim_3;
temp_int_5 = 0;
l_for_cond_2: 
 temp_boolean_4 = temp_int_5 < temp_int_4;
temp_boolean_6 = !temp_boolean_4;
 if( temp_boolean_6 ) goto l_for_fim_2;
temp_int_7= temp_int_5+ 1;
temp_int_8 = sortArray_int[temp_int_7];
temp_int_9 = sortArray_int[temp_int_5];
temp_boolean_5 = temp_int_9>temp_int_8;
  if( !temp_boolean_5 ) goto l_if_fim_1;
